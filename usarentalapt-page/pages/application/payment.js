...
const Payment = ({ apidata }) => {
  const { price, paylink } = apidata[0];

  return (
    <>
      <Head>
        <title>USA RENTAL APT|PAYMENT</title>
        ...
        <div className="mb-16 max-w-[1450px] mx-auto px-8 sm:px-12">
          ...
          <div className=" sm:ml-14">
            ...
            <p className="py-6 text-xl">
              You need to pay <span className="text-red-500">${price} </span>to
              complete your application.
            </p>
            <p className="pb-8">
              After your payment confirmation, we will send your application to
              the property owner. Check your email (inbox/spam) for application
              submit confirmation.
            </p>
